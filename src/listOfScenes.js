var story = {
    ...
    "orange": {
        events: [  //scene 6a
            ...
            new TextEvent("                ", {partDelay: 60}, {scrollSpeed: 0.025}),
            new TextEvent("                ", {partDelay: 60}, {scrollSpeed: 0.025}),
            new TextEvent("You reach into your bag and pull out the orange.", {scrollSpeed: 0.025}),
            //[A: shuffling/grabbing;]
            new AudioEvent("heartbeat2"),
            new TextEvent("                ", {partDelay: 70, scrollSpeed: 0.025}),
            new TextEvent("You hover it under Paul\'s nose.", {partDelay:55, scrollSpeed:0.025}),
            new TextEvent("Although he is still staring, you notice him wince    ", {scrollSpeed: 0.03}),
            new AudioEvent("inhale"),
            new TextEvent("whenever the orange gets close.", {shake:true, scrollSpeed: 0.025}),
            new TextEvent("                ", {partDelay: 70}),
            //[A: wind/woosh?; V: slight pulse (twice)]
            new TextEvent("You begin to peel the orange...", {partDelay: 55, scrollSpeed: 0.025}),
            new AudioEvent("grunt"),
            new TextEvent("Paul immediately snaps out of it and lets out a disgusted gasp, \"agh, get that away from me!\"", {partDelay: 45, scrollSpeed: 0.025}),
            new TextEvent("                ", {partDelay: 110}),
            //[A: groan/gasp; V: pulse/quick shake]
            new TextEvent("You ask, \"Who am I? What is going on at Macalester? Why is everything so weird?\"", {partDelay: 45, scrollSpeed: 0.025}),
            new TextEvent("Paul smiles, \"Ah, what you want is a clue. Solve this riddle and there might be an answer just for you.\"", {partDelay: 45, scrollSpeed: 0.025}),
            new TextEvent("You sigh.", {partDelay: 70, scrollSpeed: 0.021}),
            new AudioEvent("sigh"),

            new TextEvent("                ", {partDelay: 110, scrollSpeed: 0.021}),
            //[A: sigh; V: pause]
            new TextEvent("Paul continues,"),
            new TextEvent("\"A first-year\'s true path. Where one winds up at last. To strike or to hit. Only happiness and joy be fit.\"", {partDelay: 65, scrollSpeed: 0.021}),
            new TextEvent("                ", {partDelay: 90, scrollSpeed: 0.021}),
            new TextEvent("You think for a moment."),
            new TextEvent("                ", {partDelay: 110, scrollSpeed: 0.021}),
            new TextEvent("                ", {partDelay: 110, scrollSpeed: 0.021}),
            //[A: silence, hmm?; V: game pauses 2.5 seconds]
            new TextEvent("Is he talking about the Bell or the Dupre median?", {partDelay: 50, scrollSpeed: 0.021}),
        ],
        decisions: [
